    ...
    <header className="sticky top-0 z-50 bg-black">
      <nav className="flex items-center justify-between h-[60px] px-5 lg:px-8 max-w-[1800px] mx-auto relative">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="lg:hidden text-gray-400" aria-label="Buscar"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg></button>
